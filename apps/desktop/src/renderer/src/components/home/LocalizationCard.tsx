...
import type { LocalizationLanguage } from '@dubforge/types';
import { Search } from 'lucide-react';
import { useMemo, useState } from 'react';

interface LocalizationCardProps {
  languages: readonly LocalizationLanguage[];
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Select languages for translation and dubbing.</CardDescription>
      </CardHeader>
