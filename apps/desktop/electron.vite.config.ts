  ...
  main: {
    plugins: [
      externalizeDepsPlugin({
        exclude: [
          ...
          '@dubforge/assets',
          '@dubforge/media',
          '@dubforge/transcription',
          '@dubforge/localization',
          '@dubforge/voice-performance',
          '@dubforge/job-config',
          '@dubforge/types',
        ],
      }),
    ...
    resolve: {
      alias: {
        ...
        '@dubforge/assets': resolve(__dirname, '../../packages/assets/src'),
        '@dubforge/media': resolve(__dirname, '../../packages/media/src'),
        '@dubforge/transcription': resolve(__dirname, '../../packages/transcription/src'),
        '@dubforge/localization': resolve(__dirname, '../../packages/localization/src'),
        '@dubforge/voice-performance': resolve(__dirname, '../../packages/voice-performance/src'),
